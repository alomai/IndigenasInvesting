      ...
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center space-y-6">
            <img
              ...
              className="w-full aspect-[16/9] object-cover mb-6 shadow-md"
            />
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border border-black text-black px-8 py-3 font-medium bg-transparent transition-colors font-sans duration-300 border border-black hover:bg-black hover:text-white">
              Learn More →
            </button>
          </div>
        </div>
